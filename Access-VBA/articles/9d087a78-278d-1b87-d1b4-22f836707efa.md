...
The object in a bound object frame is different for each record. The bound object frame can display linked or embedded objects. If you want to display objects not stored in an underlying table, use an [unbound object frame](4a0874dc-ecac-be7c-25e2-ecc79696e2eb.md)or an [image control](1f938a6e-7aea-7787-d959-e21edaa9342c.md).
