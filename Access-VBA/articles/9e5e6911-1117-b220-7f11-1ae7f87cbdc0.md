...
|**Part**|**Description**|
|:-----|:-----|
| _fieldlist_|The name of the field or fields to be retrieved along with any field-name aliases, [SQL aggregate functions](http://msdn.microsoft.com/library/8866cd71-0216-25b4-6a6a-02cb7acad9a2%28Office.15%29.aspx), selection predicates ([ALL, DISTINCT, DISTINCTROW, or TOP](6ff5c418-897b-7d65-8551-5a0ace3c587f.md)), or other [SELECT](http://msdn.microsoft.com/library/a5c9da94-5f9e-0fc0-767a-4117f38a5ef3%28Office.15%29.aspx) statement options.|
...
| _selectcriteria_|Selection criteria. If the statement includes a [WHERE](67e4caed-6512-e8bd-39d0-6dca18114b18.md) clause, the Microsoft Access database engine orders values after applying the WHERE conditions to the records.|
