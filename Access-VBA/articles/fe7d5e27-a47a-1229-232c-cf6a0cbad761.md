...
|**Part**|**Description**|
|:-----|:-----|
| _fieldlist_|The name of the field or fields to be retrieved along with any field-name aliases, SQL aggregate functions, selection predicates ([ALL, DISTINCT, DISTINCTROW, or TOP](6ff5c418-897b-7d65-8551-5a0ace3c587f.md)), or other SELECT statement options.|
...
| _criteria_|Selection criteria. If the statement includes a [WHERE](67e4caed-6512-e8bd-39d0-6dca18114b18.md) clause, the Microsoft Access database engine groups values after applying the WHERE conditions to the records.|
...
Use the WHERE clause to exclude rows you do not want grouped, and use the [HAVING](4fc4655b-c8a6-2ca2-509e-ac98d9a1c776.md) clause to filter records after they have been grouped.
